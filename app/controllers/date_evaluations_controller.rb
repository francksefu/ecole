class DateEvaluationsController < ApplicationController
  ...
  def create
    ...
    @classroom_course = @course_teacher.classroom_course
    @date_evaluation = DateEvaluation.new(periode: @periode, classroom_course: @classroom_course,
                                          date: params[:date_evaluation][:date], maximum: params[:date_evaluation][:maximum], is_remote: params[:date_evaluation][:is_remote])
